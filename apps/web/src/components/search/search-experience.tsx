...
import { SPEAKERS } from '@/lib/corpus/glossary';
...
const SAMPLE_RESULTS = [
  {
    ...
    path: '/sutta/dn/silakkhandhavaggapali/brahmajalasuttam#para-3',
  ...
  },
  {
    ...
    path: '/sutta/kn/dhammapadapali/yamakavaggo#para-1',
  ...
  },
  {
    ...
    path: '/sutta/dn/silakkhandhavaggapali/samannaphalasuttam#para-2',
    crumb: 'Sutta · Dīgha Nikāya · Sīlakkhandha Vagga',
    pts: 'PTS i.47',
    snippet:
